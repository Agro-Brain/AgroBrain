      ...
      <div className="mx-auto max-w-7xl" ref={ref}>
        <AnimatePresence>
          {isInView && (
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} className="mb-12 text-center">
              ...
              <motion.p className="max-w-2xl mx-auto text-lg text-white/90">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => (
            ...
            >
              <div className="overflow-hidden transition-all duration-300 bg-white border-2 border-transparent shadow-lg rounded-xl hover:shadow-xl hover:border-emerald-500">
                ...
                <motion.div className="p-5 bg-gradient-to-b from-white to-gray-50" whileHover={{ y: -3 }}>
                  ...
                  <div className="w-12 h-1 mb-3 rounded-full bg-gradient-to-r from-emerald-500 to-teal-400" />
                </motion.div>
              </div>
            </motion.div>
          ))}
