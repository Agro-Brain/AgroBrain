...
const CropDiseaseDetection = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="shadow-lg bg-gradient-to-r from-green-600 to-green-700">
        <div className="container px-4 py-6 mx-auto">
          <h1 className="text-4xl font-bold text-white drop-shadow-md">Crop Disease Detection</h1>
          <p className="mt-2 text-green-100">Advanced analytics for healthier crops and sustainable farming</p>
        </div>
      </header>
